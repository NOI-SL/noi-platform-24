        ...
        >
          ...
          <div className="mt-8 text-left lg:w-1/2 md:w-1/2 w-1/2 mx-auto h-120">
            <motion.main
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="text-lg font-semibold mb-4 text-gold w-full text-center sm:text-center md:text-left lg:text-left">
                Eligibility | සුදුසුකම්
              </h2>
              <ul className="text-left list-disc text-white ">
                <li className="w-full sm:w-full md:w-full lg:w-full mt-5 mb-5">
                  The National Olympiad in Informatics program is for secondary
                  school students, and contestants should be enrolled in a
                  school.
                </li>
                <li className="w-full sm:w-full  md:w-full lg:w-full">
          ...
          >
            <div className="container mx-auto text-left flex flex-col justify-center items-center sm:justify-center sm:items-center  md:justify-left md:items-center lg:justify-left md:items-center px-4 py-8w-1/2 sm:w-1/2 lg:w-1/2 md:w-1/2  w-full text-white mt-10 mb-10">
              <h1 className="text-lg font-bold mb-4 text-gold text-center sm:text-center md:text-left lg:text-left text-gold w-full sm:w-3/4 md:w-3/4 lg:w-full mb-5">
                Process of the competition | තරඟ ක්‍රියාවලිය
              </h1>
              <p className="mb-4 text-white w-3/4 sm:w-3/4 md:w-3/4 lg:w-full mb-5">
              ...
              <ul className="list-disc ml-8 mb-4 text-white">
                <li className="w-3/4 sm:w-3/4 md:w-3/4 lg:w-full mb-5">
              ...
              <h2 className="text-lg font-semibold mb-4 text-gold w-full text-center sm:text-center md:text-left lg:text-left mt-5">
                Division A Program :
              </h2>
              ...
              <div className="flex flex-col w-full h-400">
                <h1 className="text-lg font-semibold mb-4 text-gold w-full text-center sm:text-center md:text-left lg:text-left">
                ...
                <div className="flex flex-row w-full justify-left items-center">
                  ...
                  <p className="mb-8 text-white w-1/2 sm:w-1/2 md:w-1/2 lg:w-3/4 pt-7">
              ...
              <p className="mb-8 text-white w-3/4 sm:w-3/4 md:w-3/4 lg:w-full mb-5">
                ...
                of Division A by April 2024 will be straight away participating
              ...
              <p className="text-gold w-3/4 sm:w-3/4 md:w-3/4 lg:w-full mb-5">
