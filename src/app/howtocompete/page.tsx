        ...
        <div className="relative z-10 w-full max-w-[1440px] mx-auto px-6 pt-48 pb-32">
          ...
          >
            ...
            <p className="text-slate-400 text-xl font-light leading-relaxed max-w-2xl">
              A comprehensive guide for students aspiring to represent Sri Lanka
              at the International Olympiad in Informatics (IOI) 2026.
            </p>
          </motion.div>
            ...
            >
              <div className="relative z-10">
                ...
                <div className="space-y-6 text-slate-400 font-light leading-relaxed text-base">
                  <p>
                    The National Olympiad in Informatics (NOI) is the premier
                    platform for identifying Sri Lanka&apos;s most talented
                    young computer scientists. Unlike traditional software
                    development, NOI focuses exclusively on{" "}
                  ...
                  <p>
                    Contestants are challenged to solve complex algorithmic
                    problems using logic and mathematical precision. Success
                    requires deep knowledge of data structures, algorithms, and
              ...
              <ul className="space-y-5">
                <li className="flex gap-4">
                  ...
                  <p className="text-slate-400 font-light text-sm">
                    Sri Lankan citizen enrolled in a primary or secondary
                    school.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="w-1 h-1 rounded-full bg-blue-500 mt-2 shrink-0" />
                  <p className="text-slate-400 font-light text-sm">
                    Not older than 20 years of age by July 1, 2026.
                  </p>
                </li>
                <li className="flex gap-4">
                  <div className="w-1 h-1 rounded-full bg-blue-500 mt-2 shrink-0" />
                  <p className="text-slate-400 font-light text-sm">
                    Demonstrated proficiency in algorithmic thinking.
                  </p>
                </li>
              </ul>
            </motion.section>
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
              <div className="max-w-xl text-left">
                ...
                <p className="text-slate-500 font-light text-sm">
                  Candidates must qualify through at least one of the following
                  five distinct academic and competitive pathways.
                </p>
              </div>
              ...
              {paths.map((path, index) => (
                ...
                >
                  ...
                  <div className="flex justify-between items-start mb-10 relative z-10">
                    <div
                      className={`w-12 h-12 rounded-2xl flex items-center justify-center ${path.color} shadow-lg`}
                    >
                  ...
                  <div className="relative z-10 flex-1 flex flex-col">
                    ...
                    <h4 className="text-[22px] font-bold text-white mb-2 leading-tight">
                      {path.title}
                    </h4>
                    <div className="text-[15px] font-semibold text-gray-300 mb-6">
                      {path.year}
                    </div>
          ...
          >
            ...
            <p className="text-slate-400 text-base md:text-lg text-center mb-16 max-w-2xl mx-auto font-light">
              The complete journey from eligibility verification to
              ...
              <div className="min-w-[1300px] px-4 mx-auto">
                ...
                <div className="flex mb-10">
                  <div className="w-[220px] shrink-0 border-b-2 border-dashed border-blue-500/20 pb-4 pl-2">
                    <span className="text-blue-400/80 text-xs font-bold uppercase tracking-[0.25em]">
                      Eligibility
                    </span>
                  </div>
                  ...
                  <div className="w-[220px] shrink-0 flex items-center">
                    <div className="w-full rounded-2xl border border-blue-500/20 bg-blue-500/[0.04] p-8 text-center shadow-lg transition-transform hover:-translate-y-1 hover:bg-blue-500/[0.06] duration-300">
                      ...
                      <p className="text-slate-300 text-[15px] font-medium leading-relaxed">
                        Sri Lankans who are not older than 20 yrs by July 1,
                        2026 and enrolled in a primary or secondary school
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col gap-6 justify-center">
                    ...
                    <div className="rounded-2xl border border-blue-500/30 bg-blue-500/[0.08] px-8 py-6 flex items-center gap-5 hover:bg-blue-500/15 transition-all duration-300 shadow-lg group cursor-default hover:border-blue-400/50 hover:-translate-y-1">
                      ...
                      <div>
                        ...
                        <span className="text-blue-400/80 text-xs font-semibold uppercase tracking-widest">
                          Primary Path
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="rounded-2xl border border-white/[0.08] p-7 relative mt-4 shadow-lg bg-[#0a1628]/40 backdrop-blur-sm transition-transform duration-300 hover:-translate-y-1">
                      ...
                      <div className="flex flex-col gap-4 mt-4">
                        {[
                          {
                            icon: Terminal,
                            name: "Codeforces Weekly Contests",
                          },
                          {
                            icon: School,
                            name: "National School Software Competition (NSSC)",
                          },
                          {
                            icon: User,
                            name: "Young Computer Scientist (YCS)",
                          },
                          {
                            icon: Sigma,
                          ...
                          <div
                            key={i}
                            className="rounded-xl border border-white/[0.06] bg-white/[0.02] px-6 py-4 flex items-center gap-5 text-slate-300 text-[15px] hover:border-blue-500/30 hover:bg-blue-500/5 hover:text-white transition-all duration-300"
                          >
                  ...
                  <div className="w-[280px] shrink-0 flex items-center">
                    <div className="w-full rounded-2xl border-2 border-blue-500/40 bg-blue-600/[0.1] p-10 text-center relative overflow-hidden shadow-[0_0_40px_-10px_rgba(59,130,246,0.3)] transition-transform duration-300 hover:-translate-y-1 hover:border-blue-400/60">
                      ...
                      <div className="relative z-10">
                        ...
                        <h4 className="text-white font-extrabold text-[22px] mb-3 leading-tight tracking-tight">
                          National Olympiad in Informatics
                        </h4>
                        <p className="text-blue-400/90 text-sm font-bold uppercase tracking-[0.2em]">
                          (NOI) 2026
                        </p>
                      </div>
                    </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-32">
            ...
            >
              ...
              <div>
                ...
                <p className="text-slate-500 leading-relaxed font-light text-[13px] mb-5">
                  As per the International Olympiad standards,{" "}
                  <span className="text-slate-300 font-medium">C++</span> is the
                  mandatory programming language. We advise candidates to build
                  deep proficiency in C++ STL and optimized implementations.
                </p>
                <a
            ...
            >
              ...
              <h3 className="text-white font-bold mb-2 text-sm tracking-tight">
                Host Nation
              </h3>
              <p className="text-slate-500 text-xs font-light">
                IOI 2026 will be hosted by the Republic of Uzbekistan.
              </p>
            </motion.div>
          </div>
