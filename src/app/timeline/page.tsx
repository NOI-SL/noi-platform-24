...
const Page: React.FC = () => {
  let items = [
    {
      ...
      event: "Registrations Open for NOI 2026",
      description: "",
    },
    {
      date: "March 31, 2026",
    ...
    },
    {
      ...
      description: "Day 1 of NOI 2026 will be conducted at the end of April.",
    },
    {
      date: "May 4, 2026",
      event: "NOI 2026 Day 2",
      description: "Day 2 of NOI 2026 will be conducted at the end of April.",
    },
    {
      date: "May – June, 2026",
      event: "Training Program",
      description:
        "The selected national team will undergo an intensive training program, focusing on algorithms, competitive programming techniques, and problem-solving strategies to prepare for IOI 2026.",
    },
    {
    ...
    },
    {
      ...
      description:
        "An official award ceremony will be held to recognize and celebrate students who have demonstrated outstanding performance in NOI 2026.",
    },
  ];
  ...
  function timelineItem(
    ...
    return (
      ...
      >
        <div
          className={`opacity-90 rounded card gradient-custom${index % 2 === 0 ? "-4" : ""}`}
        >
