          ...
          <>
            <div>
              ...
              >
                ...
                <h1 className="text-6xl md:text-[150px] lg:text-[250px] xl:text-[250px] 2xl:text-[300px] tracking-widest font-bold font-horus ">
                  NOI 24
                </h1>
              </motion.div>
              <motion.div
              ...
              >
                ...
                <p className="text-sm md:text-lg lg:text-[20px] xl:text-[22px] 2xl:text-[24px] tracking-widest font-sans mb-10 md:mb-15 lg:mb-20">
