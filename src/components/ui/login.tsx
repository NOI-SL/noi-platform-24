...
export const LogoutButton = () => {
    ...
    return (
        <button className="bg-white text-black border border-black px-8 py-2 rounded-md transition-colors duration-300 hover:bg-red-800 hover:text-white" onClick={() => handleLogout()}>
            Sign Out
        </button>
    );
};